   ...
   SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
      ...
      http
         .authorizeHttpRequests(authorize -> authorize
               .requestMatchers("/", "/login", "/main", "/css/**", "/js/**", "/images/**", "/user/join", 
            		 "/board/**", "/submenu/**", "/user/id_search/**", "/user/id_result", "/user/check-email",
                     "/user/check-nickname", "/user/resetpassword", "/user/resetPassword2", "/user/resetPassword").permitAll()
